      ...
      <div className="grid items-start gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-2 sm:gap-3">
            ...
            <a href="/resume.pdf" download target="_blank" rel="noreferrer" className="font-mono text-[11px] tracking-wide border border-ink px-4 py-2.5 transition-all duration-200 hover:-translate-y-0.5 hover:bg-ink hover:text-paper hover:shadow-[0_10px_30px_-8px_rgba(27,36,48,0.4)] dark:border-paper dark:hover:bg-paper dark:hover:text-ink sm:text-[12px] lg:text-[13px]">
              Download Resume →
            </a>
          </div>
