      ...
      <main className='bg-white px-10 dark:bg-gray-900 transition-all duration-300 ease-in-out'>
        <section className='min-h-screen'>
          ...
          <Image className='flex items-center rounded-md'
            ...
            <ul className='flex items-center'>
              ...
              <li className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300'>
                <a className='bg-gradient-to-t from-purple-900 to-purple-500 text-white px-4 py-2 rounded-md ml-8 font-poppins hover:bg-gradient-to-b' href="https://drive.google.com/file/d/1vgAcXqIFL968_oAlYwM_eKLUs2OXADSM/view?usp=sharing">Resume</a>
              </li>
            </ul>
          </nav>
          <div className='text-center px-13 py-10 lg:px-9'>
            ...
            <h3 className='text-l py-3 font-poppins text-gray-600 md:text-2xl dark:text-white' >Web Developer and 3D Designer.</h3>
            <p className='text-sm py-5 text-justify font-poppins font-medium text-gray-700 md:text-lg max-w-xl mx-auto dark:text-white'>budding web developer. 3D model designer. working with computers since a kid. love the challenge of creating something new. always eager to learn new technologies.
            </p>
