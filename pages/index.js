      ...
      <main className='bg-white px-10 dark:bg-gray-900 transition-all duration-300 ease-in-out'>
        <section className='min-h-screen'>
          ...
          <div className='text-center px-13 py-10 lg:px-9'>
            <h2 className='text-5xl font-worksans font-semibold py-2 text-purple-900 md:text-6xl dark:text-purple-500'>Godwin Shibu</h2>
            <h3 className='text-xl py-3 font-poppins text-gray-600 md:text-2xl dark:text-white' >Web Developer and 3D Designer.</h3>
            <p className='text-md text-sm py-5 text-justify font-poppins font-medium text-gray-700 md:text-lg max-w-xl mx-auto dark:text-white'>budding web developer. 3D model designer. working with computers since a kid. love the challenge of creating something new. always eager to learn new technologies.
            </p>
            <div className='text-5xl flex justify-center flex-wrap gap-8 px-5 py-5 text-purple-900 shadow-xl rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300 md:gap-20 hover:shadow-purple-400 dark:text-purple-500 dark:shadow-white hover:dark:shadow-purple-500'>
        ...
        <section>
            ...
            <div className='text-6xl flex justify-center flex-wrap gap-10 p-4 shadow-2xl rounded-3xl text-purple-900 hover:shadow-purple-400 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 dark:text-purple-500 hover:dark:shadow-purple-500'>
